...
function buildDoPdf(payload: {
  ...
  ops.push(drawText(36, 814, safeTruncate(payload.companyName || "WMS Pro", 42), 10, [0.86, 0.93, 1], true))
  ...
  ops.push(
    drawText(
      ...
      36,
      isPackingSlip
        ? `Packing Slip generated by ${payload.companyName || "WMS Pro"}`
        : `Dispatch Note generated by ${payload.companyName || "WMS Pro"}`,
      9,
      [0.42, 0.45, 0.49]
    )
  )
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  const pdfBytes = buildDoPdf({
    companyName: String(row.company_name || "WMS Pro"),
